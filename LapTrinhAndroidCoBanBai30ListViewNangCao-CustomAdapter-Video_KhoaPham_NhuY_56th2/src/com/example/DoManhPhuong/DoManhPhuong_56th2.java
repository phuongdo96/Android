package com.example.DoManhPhuong;
...
public class DoManhPhuong_56th2 extends Activity {
 ListView lv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main_DoManhPhuong_56th2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.DoManhPhuong_56th2, menu);
        return true;
    }
